...
/// <summary>
/// Creates a new instance of a persistence store for users, without role support, using the default implementation
/// of <see cref="IdentityUserEF6"/> with a string as a primary key.
/// </summary>
public class UserOnlyStoreEF6 : UserOnlyStoreEF6<IdentityUserEF6, IdentityEF6DbContext, string, IdentityUserClaimEF6, IdentityUserLoginEF6, IdentityUserTokenEF6<string>>
{
    /// <summary>
    /// Constructs a new instance of <see cref="UserOnlyStoreEF6"/>.
    /// </summary>
    /// <param name="context">The <see cref="DbContext"/>.</param>
    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
    public UserOnlyStoreEF6(IdentityEF6DbContext context, IdentityErrorDescriber? describer = null) : base(context, describer)
    {
    }
}

/// <summary>
/// Creates a new instance of a persistence store for the specified user type, without role support.
/// </summary>
/// <typeparam name="TUser">The type representing a user.</typeparam>
public class UserOnlyStoreEF6<TUser> : UserOnlyStoreEF6<TUser, DbContext, string>
    where TUser : IdentityUserEF6<string, IdentityUserLoginEF6<string>, IdentityUserRoleEF6<string>, IdentityUserClaimEF6<string>>, new()
{
    /// <summary>
    /// Constructs a new instance of <see cref="UserOnlyStoreEF6{TUser}"/>.
    /// </summary>
    /// <param name="context">The <see cref="DbContext"/>.</param>
    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
    public UserOnlyStoreEF6(DbContext context, IdentityErrorDescriber? describer = null) : base(context, describer)
    {
    }
}

/// <summary>
/// Represents a new instance of a persistence store for the specified user type, without role support.
/// </summary>
/// <typeparam name="TUser">The type representing a user.</typeparam>
/// <typeparam name="TContext">The type of the data context class used to access the store.</typeparam>
public class UserOnlyStoreEF6<TUser, TContext> : UserOnlyStoreEF6<TUser, TContext, string>
    where TUser : IdentityUserEF6<string, IdentityUserLoginEF6<string>, IdentityUserRoleEF6<string>, IdentityUserClaimEF6<string>>, new()
    where TContext : DbContext
{
    /// <summary>
    /// Constructs a new instance of <see cref="UserOnlyStoreEF6{TUser, TContext}"/>.
    /// </summary>
    /// <param name="context">The <see cref="DbContext"/>.</param>
    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
    public UserOnlyStoreEF6(TContext context, IdentityErrorDescriber? describer = null) : base(context, describer)
    {
    }
}
...
public class UserOnlyStoreEF6<TUser, TContext, TKey> : UserOnlyStoreEF6<TUser, TContext, TKey, IdentityUserClaimEF6<TKey>, IdentityUserLoginEF6<TKey>, IdentityUserTokenEF6<TKey>>
    where TUser : IdentityUserEF6<TKey, IdentityUserLoginEF6<TKey>, IdentityUserRoleEF6<TKey>, IdentityUserClaimEF6<TKey>>, new()
    where TContext : DbContext
    where TKey : IEquatable<TKey>
{
    /// <summary>
    /// Constructs a new instance of <see cref="UserOnlyStoreEF6{TUser, TContext, TKey}"/>.
    /// </summary>
    /// <param name="context">The <see cref="DbContext"/>.</param>
    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
    public UserOnlyStoreEF6(TContext context, IdentityErrorDescriber? describer = null) : base(context, describer)
...
/// <summary>
/// Represents a new instance of a persistence store for users only (no role support).
/// </summary>
/// <typeparam name="TUser">The type representing a user.</typeparam>
/// <typeparam name="TContext">The type of the data context class used to access the store.</typeparam>
/// <typeparam name="TKey">The type of the primary key for a user.</typeparam>
...
public class UserOnlyStoreEF6<TUser, TContext, TKey, TUserClaim, TUserLogin, TUserToken> :
...
{
    /// <summary>
    /// Constructs a new instance of <see cref="UserOnlyStoreEF6{TUser, TContext, TKey, TUserClaim, TUserLogin, TUserToken}"/>.
    /// </summary>
    /// <param name="context">The <see cref="DbContext"/>.</param>
    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
    public UserOnlyStoreEF6(TContext context, IdentityErrorDescriber? describer = null) : base(describer ?? new IdentityErrorDescriber())
    {
    ...
    public override Task AddClaimsAsync(TUser user, IEnumerable<Claim> claims, CancellationToken cancellationToken = default)
    {
        ...
        {
            Context.Set<TUserClaim>().Add(CreateUserClaim(user, claim));
        }
    ...
    public override Task AddLoginAsync(TUser user, UserLoginInfo login, CancellationToken cancellationToken = default)
    {
        ...
        Context.Set<TUserLogin>().Add(CreateUserLogin(user, login));
        return Task.CompletedTask;
    }
    ...
    public override async Task RemoveLoginAsync(TUser user, string loginProvider, string providerKey, CancellationToken cancellationToken = default)
    {
        ...
        var login = await Context.Set<TUserLogin>()
            .FirstOrDefaultAsync(l => l.UserId.Equals(user.Id) && l.LoginProvider == loginProvider && l.ProviderKey == providerKey, cancellationToken);

        if (login != null)
        {
            Context.Set<TUserLogin>().Remove(login);
        }
    }
