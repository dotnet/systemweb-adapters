...
internal class HttpResponseAdapterFeature : Stream, IHttpResponseBodyFeature, IHttpResponseBufferingFeature, IHttpResponseEndFeature
{
    ...
    void IHttpResponseBufferingFeature.ClearContent()
    {
        VerifyBuffering();
