...
public abstract class HttpTaskAsyncHandler : IHttpAsyncHandler, IHttpHandler
{
    ...
    IAsyncResult IHttpAsyncHandler.BeginProcessRequest(HttpContext context, AsyncCallback cb, object? extraData)
        => new TaskWithState(ProcessRequestAsync(context).ContinueWith(t => cb(t), ((HttpContextCore)context).RequestAborted, TaskContinuationOptions.None, TaskScheduler.Current), extraData);
