...
public static class RemoteAppServerExtensions
{
    ...
    /// </summary>
    public static ISystemWebAdapterRemoteServerAppBuilder AddRemoteAppServer(this ISystemWebAdapterBuilder builder, Action<RemoteAppServerOptions> configure)
    {
        if (builder is null)
        {
