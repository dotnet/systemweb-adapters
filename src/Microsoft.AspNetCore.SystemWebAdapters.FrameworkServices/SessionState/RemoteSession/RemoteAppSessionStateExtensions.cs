...
{
    public static ISystemWebAdapterRemoteServerAppBuilder AddSessionServer(this ISystemWebAdapterRemoteServerAppBuilder builder, Action<RemoteAppSessionStateServerOptions>? configureRemote = null)
    {
        if (builder is null)
        {
